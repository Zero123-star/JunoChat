...
const mockCreateCharacterAPI = vi.hoisted(() => vi.fn())
const mockNavigate = vi.hoisted(() => vi.fn())

// Mock API
vi.mock('@/api', () => ({
  createCharacter: mockCreateCharacter,
  createCharacterAPI: mockCreateCharacterAPI
}))
...
describe('AddCharacterPage', () => {
  beforeEach(() => {
    ...
    mockCreateCharacterAPI.mockResolvedValue({ status: 'created', character: 'Test Character' })
  })
  ...
  test('handles form submission successfully', async () => {
    ...
    await waitFor(() => {
      ...
      expect(mockCreateCharacterAPI).toHaveBeenCalled()
  ...
  test('handles form submission error', async () => {
    ...
    await user.type(screen.getByLabelText('Name'), 'Test Character')
    await user.type(screen.getByLabelText('Description'), 'Test Description')
    ...
    // Test error from FastAPI
    mockCreateCharacter.mockResolvedValue({ id: '1', message: 'Character created successfully' })
    mockCreateCharacterAPI.mockRejectedValue(new Error('Failed to create character'))
