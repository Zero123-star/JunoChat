...
from api.views import GroupChatViewSet, GroupChatMessageViewSet
...
router.register(r'messages', MessageViewSet, basename='messages')  # Added
...
urlpatterns = [
    ...
    path('api/group_chats/', include(group_chats_router.urls)),
